      ...
      {posts.map((post) => (
        <div key={post.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div className="px-2 py-1 flex items-center justify-between">
                <button className="flex items-center justify-center gap-2 px-3 py-3 hover:bg-gray-100 rounded flex-1 transition-colors group">
                    <ThumbsUp className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
                    <span className="text-sm font-semibold text-gray-600 group-hover:text-gray-800">Like</span>
                </button>
                <button className="flex items-center justify-center gap-2 px-3 py-3 hover:bg-gray-100 rounded flex-1 transition-colors group">
                    <MessageSquare className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
                    <span className="text-sm font-semibold text-gray-600 group-hover:text-gray-800">Comment</span>
                </button>
                <button className="flex items-center justify-center gap-2 px-3 py-3 hover:bg-gray-100 rounded flex-1 transition-colors group">
                    <Repeat className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
                    <span className="text-sm font-semibold text-gray-600 group-hover:text-gray-800">Repost</span>
                </button>
                <button className="flex items-center justify-center gap-2 px-3 py-3 hover:bg-gray-100 rounded flex-1 transition-colors group">
                    <Send className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
                    <span className="text-sm font-semibold text-gray-600 group-hover:text-gray-800">Send</span>
                </button>
            </div>
        </div>
      ))}
